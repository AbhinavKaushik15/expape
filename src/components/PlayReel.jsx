    ...
    <div ref={parent} className='w-full h-screen bg-[#0D0E13]'>
        ...
        ></path>
          ...
          <div className="centerPlayReelSm flex sm:hidden absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-[999] items-center justify-center gap-[19vw]">
            <h1 ref={playSm} className='text-[16vw] font-[400]'>Play</h1>
            <h1 ref={reelSm} className='text-[16vw] font-[400]'>Reel</h1>
          </div>

          <div ref={videodivSm} className="bgVideo flex sm:hidden absolute w-[43vw] h-[22vw] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-video">
