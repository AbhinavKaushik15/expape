...
function Menu() {
  ...
  return (
    <div ref={menuOpen} className={`fixed top-[-100%] z-[999] w-full h-screen ${!isOpen === false ? "bg-transparent": 'bg-[#0D0E13]'} mx-auto flex items-center justify-between py-5 sm:py-[3.5%] px-7 sm:px-[3.5%]`}>
      <div className="left hidden sm:flex relative h-[91vh] w-[37.7vw]">
        ...
        <svg
            ...
            className="w-24 sm:w-[27.2%] hidden sm:flex sm:absolute left-0 top-0 text-white"
          >
            <path
        ...
        <div className="img_continer absolute w-[21.3vw] h-[30.2vw] top-1/2 -translate-y-1/2 right-0">
          <img
        ...
        <h1 className="text-[#dadada] absolute bottom-0 left-0 text-[1.17vw]">
          Play Reel
        </h1>
      </div>
      ...
      <div className="right relative h-[91vh] w-full sm:w-[37.7vw]">
        <div className="close flex sm:absolute sm:top-0 sm:right-0 text-white items-center justify-between">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="w-24 sm:w-[27.2%] flex sm:hidden"
          >
            <path
              d="M7.70542 17.0085C10.8808 17.2469 13.8123 15.2096 14.8524 12.0415H11.0216C10.4531 13.3929 9.1325 14.2151 7.73401 14.0885C5.56111 14.1223 3.7654 12.3119 3.7031 10.0246H15.1383V9.42253C15.1383 4.45554 12.9656 0.391646 7.64824 0.391646C5.56968 0.342653 3.56563 1.20734 2.11735 2.77806C0.66907 4.34878 -0.0925972 6.48364 0.0152567 8.66995C-0.119195 10.8796 0.639738 13.0461 2.10466 14.6345C3.56958 16.223 5.60394 17.0852 7.70542 17.0085ZM11.4473 7.22456H3.69995V7.16435C3.85008 4.98837 5.57318 3.30544 7.64509 3.31117C8.64896 3.27405 9.62348 3.67141 10.3418 4.41075C11.0601 5.15009 11.4596 6.16692 11.4473 7.22456Z"
              fill="currentColor"
        ...
        <div className="absolute w-full ml-6 sm:ml-0 sm:w-[21.3vw] h-[30.2vw] top-1/2 -translate-y-1/2 left-0 font-[Lausanne_300] leading-[1.3]">
          <div className="texts absolute w-full h-fit top-1/2 -translate-y-1/2">
            <div className="headings text-white">
              {["Work", "Studio", "News", "Contact"].map((items, index) => {
                return (
                  <h1 key={index} className="text-[9vw] sm:text-[3.5vw] leading-[1.1] font-[400] overflow-hidden">
                    <motion.span
            ...
            <div className="paras hidden sm:flex flex-col text-[#888] mt-[2vw] leading-[2] sm:leading-[1.4]">
              {["Behance", "Dribbble", "Twitter", "Instagram"].map(
                (item, index) => {
                  return (
                    <a key={index} className="text-[1.2vw] overflow-hidden" href="#">
                      <motion.span
                        initial={{ rotate: 30, translateY: "50%", opacity: 0 }}
                        whileInView={{ rotate: 0, translateY: 0, opacity: 1 }}
                        transition={{ ease: Power4.easeInOut, duration: 1, delay: 0.5+0.1*index }}
                        className="inline-block origin-left"
                      >
                        {item}
                      </motion.span>
        ...
        <h1 className="flex sm:hidden underline text-[3.5vw] text-white mt-[61vh] ml-6">
          Now Hiring!
        </h1>

        <h1 className="flex sm:hidden text-[#888] ml-6 mt-5 text-[3vw]">
          Play Reel
        </h1>

        <a
          className="flex sm:hidden text-[#888] text-[3vw] ml-6 mt-2"
          href="#"
        >
          Our Story
        </a>
        ...
        <a
          className="hidden sm:flex absolute text-[#888] text-[1.1vw] left-0 bottom-0"
          href="#"
        >
          Our Story
        </a>

        <h1 className="hidden sm:flex absolute bottom-0 right-0 underline text-[1.23vw] text-white">
          Now Hiring!
        </h1>
      </div>
